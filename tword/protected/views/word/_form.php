...
<div class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <a id="auto_translate" class="btn btn-primary btn-lg btn-block" href="#">
                <span class="glyphicon glyphicon-globe"></span> 自动翻译
            </a>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <?php echo CHtml::submitButton($model->isNewRecord ? '添加到单词本' : '保存', array('class' => 'btn btn-warning  btn-lg btn-block')); ?>
        </div>
    </div>
    <?php $this->endWidget(); ?>
